...
class App extends Component {
  ...
  changeLanguage = event => this.setState({ language: event.currentTarget.lang });

  clearLanguagePopup = doNotShowAgain => this.setState({ doNotShowLanguagePopupAgain: doNotShowAgain });
