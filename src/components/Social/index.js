  ...
  return (
    <div className="hero__social">
      <div className="hero__social--inner">
        <a
          className="hero__social--link-mail"
      ...
      <div className="hero__social--inner hero__social--link">
        <a
          className="hero__social--link hero__social--link-skype"
          href="skype:live%3Aanna.branco_3?call"
        >
          <i className="fab fa-skype icon-call"></i>
          <p className="hero__social-text">{texts.call}</p>
        </a>
        <a
          className="hero__social--link hero__social--link-skype"
        ...
        >
          ...
          <p className="hero__social-text">{texts.chat}</p>
        </a>
      </div>
    </div>
  );
