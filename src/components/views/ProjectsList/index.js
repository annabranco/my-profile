...
import { SHOW_THUMBNAILS_ACTION, SHOW_ACTION } from '../../../constants';
...
export const ProjectsList = ({
  ...
  const handleProjectsListScroll = () => {
    if (!seeAllProjects) {
    }
  };
  ...
  return (
    <Fragment>
      ...
      <ul className={`projects__list${projectsListClasses()}`}>
